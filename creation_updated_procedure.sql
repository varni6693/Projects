...
p_date_of_appt IN customer_schedule.date_of_appt%TYPE,  
...
INSERT INTO customer_schedule VALUES(cs_id_sequence.nextval,p_cid,p_tid,p_date_of_appt); 
INSERT INTO hair_stylist_schedule VALUES(hs_id_sequence.nextval,p_date_of_appt,p_hid,p_tid);

INSERT INTO appointment values (appointment_id_sequence.nextval,cs_id_sequence.currval,hs_id_sequence.currval);

COMMIT;  

END insert_appoitment_details; 

execute insert_appoitment_details('1','102',SYSDATE,'301');
